...
### Enhancements
- **feat(slack): automatically join channels.** Have the Slack application automatically attempt to join the channel it was configured to read; report a clear per-channel error when the bot lacks access.
